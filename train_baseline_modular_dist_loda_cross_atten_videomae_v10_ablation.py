...
def save_checkpoint(model, optimizer, scheduler, epoch, old_save_name, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10_ablation.pth'):
    """保存模型的checkpoint"""
    state = {
...
def load_checkpoint(model, optimizer, scheduler, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10_ablation.pth'):
    """加载模型的checkpoint"""
...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_ablation':
        model = modular.ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_ablation(feat_len=8, sr=True, tr=True, dr=True, ar=True,
                                                                           dropout_sp=0.1, dropout_tp=0.2, dropout_dp=0.2, dropout_ap=0.2)

    print('The current model is ' + config.model_name)
    # print('ablation 1: i % 3 == 0')
    # print('ablation 2: i % 6 == 0')
    # print('ablation 3: i % 12 == 0')
    print('ablation 5 , temporal cat semantic-distortion')
    ...
    # start_epoch, old_save_name = load_checkpoint(model, optimizer, scheduler, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10_ablation.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_ablation')
