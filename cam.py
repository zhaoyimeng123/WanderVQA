...
def get_args():
    ...
    parser.add_argument(
        '--image-path',
        type=str,
        default='/data/user/zhaoyimeng/ModularBVQA/data/konvid1k_image_all_fps1/10008004183/000.png',
    ...
    parser.add_argument('--output-dir', type=str, default='/data/user/zhaoyimeng/ModularBVQA/result',
