...
def main(config):
    ...
    all_test_SRCC_a, all_test_KRCC_a, all_test_PLCC_a, all_test_RMSE_a = [], [], [], []
    ...
    for i in range(10):
        ...
        all_test_SRCC_a.append(best_test_a[0])
        all_test_KRCC_a.append(best_test_a[1])
        all_test_PLCC_a.append(best_test_a[2])
        all_test_RMSE_a.append(best_test_a[3])
    ...
    print(
        'The A median results SRCC: {:.4f}, KRCC: {:.4f}, PLCC: {:.4f}, and RMSE: {:.4f}'.format(
            np.median(all_test_SRCC_a), np.median(all_test_KRCC_a), np.median(all_test_PLCC_a),
            np.median(all_test_RMSE_a)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='ViTbCLIP_SpatialTemporalDistortionAes_modular_dropout', type=str)
    ...
    parser.add_argument('--trained_model', type=str,
                        default='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/ViTbCLIP_SpatialTemporalDistortionAes_modular_dropout_LSVQ_plcc_NR_vNone_epoch_4_SRCC_0.886242.pth')
