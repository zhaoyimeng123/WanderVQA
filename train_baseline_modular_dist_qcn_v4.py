...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortion_QCN_modular_dropout_v4':
        model = modular.ViTbCLIP_SpatialTemporalDistortion_QCN_modular_dropout_v4(feat_len=8, sr=True, tr=True, dr=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortion_QCN_modular_dropout_v4')
