...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortionAes_modular_dropout_cross_attention_v2':
        model = modular.ViTbCLIP_SpatialTemporalDistortionAes_modular_dropout_cross_attention_v2(feat_len=8, sr=True, tr=True, dr=True, ar=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortionAes_modular_dropout_cross_attention_v2')
