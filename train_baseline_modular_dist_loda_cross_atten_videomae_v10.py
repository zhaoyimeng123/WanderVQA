...
def save_checkpoint(model, optimizer, scheduler, epoch, old_save_name, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10.pth'):
    """保存模型的checkpoint"""
    state = {
...
def load_checkpoint(model, optimizer, scheduler, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10.pth'):
    """加载模型的checkpoint"""
...
def main(config):
    ...
    start_epoch, old_save_name = load_checkpoint(model, optimizer, scheduler,
                                  path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10')
    ...
    parser.add_argument('--exp_version', type=int, default=444)
