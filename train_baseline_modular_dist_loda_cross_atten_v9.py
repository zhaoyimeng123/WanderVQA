...
def save_checkpoint(model, optimizer, scheduler, epoch, old_save_name, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v9_222.pth'):
    """保存模型的checkpoint"""
    state = {
...
def load_checkpoint(model, optimizer, scheduler, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v9_222.pth'):
    """加载模型的checkpoint"""
...
def main(config):
    ...
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_v9':
        model = modular.ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_v9(feat_len=8, sr=True, tr=True, dr=True, ar=True,
    ...
    start_epoch, old_save_name = load_checkpoint(model, optimizer, scheduler,
                                                 path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v9_222.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_v9')
