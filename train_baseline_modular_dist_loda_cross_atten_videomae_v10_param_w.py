...
def save_checkpoint(model, optimizer, scheduler, epoch, old_save_name, path='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/checkpoint_v10_param_w.pth'):
    """保存模型的checkpoint"""
    state = {
...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_param_w':
        model = modular.ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_param_w(feat_len=8, sr=True, tr=True, dr=True, ar=True,
    ...
    if config.database == 'LSVQ':
        ...
        t_dir = '/data/user/zhaoyimeng/ModularBVQA/data/LSVQ_t'
        ...
        trainset = VideoDataset_images_with_LP_motion_dist_aes_videomae_features(videos_dir, feature_dir, lp_dir, datainfo_train,
                                                                    ...
                                                                    config.crop_size,
                                                                    'Fast', t_dir, aes_dir, videomae_feat)
        ...
        testset_1080p = VideoDataset_images_with_LP_motion_dist_aes_videomae_features(videos_dir, feature_dir, lp_dir,
                                                                         ...
                                                                         config.crop_size, 'Fast', t_dir, aes_dir, videomae_feat)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortion_loda_modular_dropout_cross_attention_videomae_v10_param_w')
