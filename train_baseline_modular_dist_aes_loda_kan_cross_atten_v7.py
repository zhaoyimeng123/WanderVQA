...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortionAes_loda_kan_modular_dropout_cross_attention_v7':
        model = modular.ViTbCLIP_SpatialTemporalDistortionAes_loda_kan_modular_dropout_cross_attention_v7(feat_len=8, sr=True, tr=True, dr=True, ar=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortionAes_loda_kan_modular_dropout_cross_attention_v7')

    # training parameters
    # parser.add_argument('--conv_base_lr', type=float, default=1e-5)
    parser.add_argument('--conv_base_lr', type=float, default=0.000008)
    ...
    parser.add_argument('--checkpoint_resume', type=str, default='/data/user/zhaoyimeng/ModularBVQA/ckpts_modular/ViTbCLIP_SpatialTemporalDistortionAes_loda_kan_modular_dropout_cross_attention_v7_LSVQ_plcc_rank_NR_vNone_epoch_3_SRCC_0.878247.pth')
