...
def main(config):
    ...
    # distortion
    if config.model_name == 'ViTbCLIP_SpatialTemporalDistortionAes_loda_modular_dropout_cross_attention_v8_abla':
        model = modular.ViTbCLIP_SpatialTemporalDistortionAes_loda_modular_dropout_cross_attention_v8_abla(feat_len=8, sr=True, tr=True, dr=True, ar=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='ViTbCLIP_SpatialTemporalDistortionAes_loda_modular_dropout_cross_attention_v8_abla')
